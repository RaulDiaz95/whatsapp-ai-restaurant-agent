...
export function buildIntentPrompt(): string {
  return [
    ...
    '- Example: "quiero 2 spicy tuna y 1 dragon roll" -> items must contain both products.',
    ...
    "- Never collapse multiple products into a single item.",
    "- Never summarize quantities across different products.",
