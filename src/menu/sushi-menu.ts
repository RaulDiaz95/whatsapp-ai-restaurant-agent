...
export const sushiMenu: MenuItem[] = [
  ...
  },
  {
    ...
    price: 165,
    description: "Atún picante con pepino y ajonjolí.",
  ...
  },
  {
    name: "Dragon Roll",
    price: 190,
    description: "Camarón tempura, pepino y aguacate por fuera.",
    aliases: ["dragon"],
    extras: defaultExtras,
    modifiers: defaultModifiers,
  },
  {
    name: "Tempura Roll",
    price: 175,
    description: "Rollo empanizado con camarón y queso crema.",
    aliases: ["tempura"],
    extras: defaultExtras,
    modifiers: defaultModifiers,
  },
  {
    name: "Salmón Nigiri",
    price: 140,
    description: "Bocado de arroz con salmón fresco.",
    aliases: ["nigiri de salmon", "nigiri de salmón", "salmon", "salmón"],
    extras: defaultExtras,
    modifiers: defaultModifiers,
  },
  {
    name: "Tuna Nigiri",
    price: 145,
    description: "Bocado de arroz con atún fresco.",
    aliases: ["nigiri de atun", "nigiri de atún", "atun", "atún"],
    extras: defaultExtras,
    modifiers: defaultModifiers,
  },
  {
    name: "Ebi Roll",
    price: 170,
    description: "Camarón, aguacate y pepino.",
    aliases: ["ebi"],
    extras: defaultExtras,
    modifiers: defaultModifiers,
  },
